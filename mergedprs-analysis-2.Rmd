...
We can see there is an outlier with 46 non-trivial partitions. This pull request consists of a refactoring where the return type of several methods was changed and test cases were added for these methods. Due to the limitations of ClusterChanges, a lot of partitions were generated for this pull request.

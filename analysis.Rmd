...
```{r, echo=FALSE, warning=FALSE, comment=""}
trivialPartitionsQuantiles <- quantile(x=summ$trivialPartitions, probs=seq(0.05, 1, 0.05))
...
```{r, echo=FALSE, warning=FALSE, comment=""}
nonTrivialPartitionsQuantiles <- quantile(x=summ$nonTrivialPartitions, probs=seq(0.05, 1, 0.05))

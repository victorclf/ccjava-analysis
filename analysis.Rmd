...
* $<= 1$ non-trivial partition (`r percent(nonTrivialPartitionsECDF(1))`): We manually investigated a random sample of 50 changesets that fall under this category.
...
### TODO: Comparison with partition histograms of the original study?
